...
async.series([
  ...
  function (nextStep) {
    ...
    setTimeout(function () {
      console.log(chalk.green('SUCCESS: Generated static site in directory: ./build'))
      const web = require('node-static')
      const port = 8080
      const http = require('http')
      const file = new web.Server('./build', {
        cache: 3600,
        gzip: true
      })
      console.log(chalk.green('SUCCESS: Nerds herded at http://127.0.0.1:8080'))
